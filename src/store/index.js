...
export default createStore({
  state: {
    ...
    charawanShops: [
      {
        name: "",
        hindiName: "तिवारी हार्डवेयर एंड मशीनरी स्टोर ",
        ownerName: "अजीत कुमार तिवारी",
        inCharawan: true,
        shopPlace: "",
        address: "श्री हरि दुर्गा मंदिर के बगल",
        shopType: "machineryStore",
        numbers: ["9696865230", "9838539922"],
        since: "20",
        openTiming: "6AM",
        closeTiming: "8PM",
        closedOn: "",
        info: "हमारी प्रथम भूमिका है आपकी संतुष्टि ",
        distance: "",
        photosLink: [""],
        ownerPhoto: "",
        homeDelivery: true,
