<template>
<section id="story">
    <div class="story-section text-center mt-2 mt-lg-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="text-content">
                       ...
                       <button class="btn btn-info mt-4 ">
                          <router-link class="text-decoration-none text-dark" to='/itihas'> ...और जाने </router-link>
                       </button>
                    </div>
                </div>
            </div>
...
.story-section{
    width: 100%;
    height: 28.1rem;
    background: url('https://i.ibb.co/T2xCBD8/ch1.png') no-repeat center;
